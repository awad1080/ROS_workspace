...
class NGIMUAuxserial {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.char(obj.message1, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NGIMUAuxserial(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [message1]
    data.message1 = _deserializer.char(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'ngimu/NGIMUAuxserial';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '457a1a31d716e60a93d0e0a2484d0096';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NGIMUAuxserial(null);
